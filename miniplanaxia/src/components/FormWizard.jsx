...
import Loader from './SuccessModal';
...
export default function FormWizard() {
  ...
  const nextSection = (sectionData) => {
    ...
    const enviarFormulario = () => {
      ...
      return axios.post('https://server-axia-eosin.vercel.app/api/miniplan', newFormData, {
  ...
  return (
    ...
    <>
      ...
      {modalOpen && <Loader profitclient={profitclient} onClose={() => setModalOpen(false)} />}
      {modalOpen2 && <SuccessModal profitclient={profitclient} datos={formData} pdf={pdf} onClose={() => setModalOpen(false)} />}
    </>
  );
}
